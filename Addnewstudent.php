...
if(isset($_REQUEST['btnSave']))
	{
		...
		$chk=$objStudent->sel("select * from student where RegNo like '".$regNo."'");
		$row1=mysql_fetch_array($chk);
		if($row1[0])
		{
			print "Invalid Register Number";					
			print "Click on <a href=Addnewstudent.php> this link</a> to go to the previous page";
		}
		else
		{	
