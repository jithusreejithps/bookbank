...
else
{
	...
	//print "<input type=hidden id=txtRegNo name=txtRegNo value=$reg/>";
	...
	if(!$row)
		...
		print "<br> Click <a href=ViewstudentDetails.php>here</a> to go back";
		}
	else
	{
		print "<center>";
		print "<h1><label>Details Of ".$row[1]."</h1></label><br><br>";
